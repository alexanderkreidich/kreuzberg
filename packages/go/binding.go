...
func ResolveThreadBudget(config *string) *uint {
    ...
    ptr := C.kreuzberg_resolve_thread_budget(cConfig)
...
func BuildConfigFromJson(base ExtractionConfig, override_json *string) (*ExtractionConfig, error) {
    ...
    var cOverrideJson *C.char
    if override_json != nil {
        cOverrideJson = C.CString(*override_json)
        defer C.free(unsafe.Pointer(cOverrideJson))
    }

    ptr := C.kreuzberg_build_config_from_json(cBase, cOverrideJson)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_extraction_config_free(ptr)
        }
...
func ValidateVlmBackendConfig(backend string, vlm_config *LlmConfig) error {
    ...
    jsonBytescVlmConfig, err := json.Marshal(vlm_config)
    if err != nil {
        return fmt.Errorf("failed to marshal: %w", err)
    }
    tmpStrcVlmConfig := C.CString(string(jsonBytescVlmConfig))
    cVlmConfig := C.kreuzberg_llm_config_from_json(tmpStrcVlmConfig)
    C.free(unsafe.Pointer(tmpStrcVlmConfig))
    defer C.kreuzberg_llm_config_free(cVlmConfig)

    C.kreuzberg_validate_vlm_backend_config(cBackend, cVlmConfig)
    return lastError()
}
...
func ApplyOutputFormat(result ExtractionResult, output_format string) *ExtractionResult {
...
func ParseJson(data []byte, config *string) (*StructuredDataResult, error) {
    ...
    ptr := C.kreuzberg_parse_json(cData, cConfig)
    if err := lastError(); err != nil {
        if ptr != nil {
...
func ParseJsonl(data []byte, config *string) (*StructuredDataResult, error) {
    ...
    ptr := C.kreuzberg_parse_jsonl(cData, cConfig)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_structured_data_result_free(ptr)
        }
...
func GenerateElementId(text string, element_type ElementType, page_number *uint) *string {
    ...
    var cPageNumber C.size_t = C.size_t(^uint(0))
    if page_number != nil {
        cPageNumber = C.size_t(uint(*page_number))
    }

    ptr := C.kreuzberg_generate_element_id(cText, cElementType, cPageNumber)
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func ParseMsgContent(data []byte, fallback_codepage *uint32) (*EmailExtractionResult, error) {
    ...
    ptr := C.kreuzberg_parse_msg_content(cData, cFallbackCodepage)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_email_extraction_result_free(ptr)
        }
...
func ExtractEmailContent(data []byte, mime_type string, fallback_codepage *uint32) (*EmailExtractionResult, error) {
    ...
    ptr := C.kreuzberg_extract_email_content(cData, cMimeType, cFallbackCodepage)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_email_extraction_result_free(ptr)
        }
...
func ConvertHtmlToMarkdown(html string, options *string, output_format *string) (*string, error) {
    ...
    var cOutputFormat *C.char
    if output_format != nil {
        cOutputFormat = C.CString(*output_format)
        defer C.free(unsafe.Pointer(cOutputFormat))
    }

    ptr := C.kreuzberg_convert_html_to_markdown(cHtml, cOptions, cOutputFormat)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_free_string(ptr)
        }
...
func ConvertHtmlToMarkdownWithMetadata(html string, options *string, output_format *string) (*string, error) {
    cHtml := C.CString(html)
    defer C.free(unsafe.Pointer(cHtml))
    ...
    ptr := C.kreuzberg_convert_html_to_markdown_with_metadata(cHtml, cOptions, cOutputFormat)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_free_string(ptr)
        }
...
func ConvertHtmlToMarkdownWithTables(html string, options *string, output_format *string) (*string, error) {
    cHtml := C.CString(html)
    defer C.free(unsafe.Pointer(cHtml))
    ...
    ptr := C.kreuzberg_convert_html_to_markdown_with_tables(cHtml, cOptions, cOutputFormat)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_free_string(ptr)
        }
...
func ExtractHtmlInlineImages(html string, options *string) (*[]string, error) {
    ...
    ptr := C.kreuzberg_extract_html_inline_images(cHtml, cOptions)
    if err := lastError(); err != nil {
        return nil, err
    }
    return func() *[]string {
...
func SafeDecode(byte_data []byte, encoding *string) *string {
    ...
    ptr := C.kreuzberg_safe_decode(cByteData, cEncoding)
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func IsMarkdownHeader(line string) *bool {
    ...
    ptr := C.kreuzberg_is_markdown_header(cLine)
    return func() *bool { v := ptr != 0; return &v }()
}
...
func LoadServerConfig(config_path *string) (*ServerConfig, error) {
    ...
    if config_path != nil {
        cConfigPath = C.CString(*config_path)
        defer C.free(unsafe.Pointer(cConfigPath))
    }

    ptr := C.kreuzberg_load_server_config(cConfigPath)
    if err := lastError(); err != nil {
        if ptr != nil {
...
func DetectPlainTextBoundaries(text string) *[]DetectedBoundary {
    ...
    ptr := C.kreuzberg_detect_plain_text_boundaries(cText)
    return func() *[]DetectedBoundary {
	if ptr == nil { return nil }
	defer C.kreuzberg_free_string(ptr)
...
func ClassifyChunk(content string, heading_context *HeadingContext) *ChunkType {
    ...
    jsonBytescHeadingContext, err := json.Marshal(heading_context)
    if err != nil {
        panic(fmt.Sprintf("failed to marshal: %v", err))
    }
    tmpStrcHeadingContext := C.CString(string(jsonBytescHeadingContext))
    cHeadingContext := C.kreuzberg_heading_context_from_json(tmpStrcHeadingContext)
    C.free(unsafe.Pointer(tmpStrcHeadingContext))
    defer C.kreuzberg_heading_context_free(cHeadingContext)

    ptr := C.kreuzberg_classify_chunk(cContent, cHeadingContext)
...
func MergeSegments(source_text string, segments []string, boundaries []bool, max_characters uint, overlap uint) *[]MergedChunk {
    cSourceText := C.CString(source_text)
    ...
    ptr := C.kreuzberg_merge_segments(cSourceText, cSegments, cBoundaries, cMaxCharacters, cOverlap)
    return func() *[]MergedChunk {
	if ptr == nil { return nil }
	defer C.kreuzberg_free_string(ptr)
...
func BuildCellGrid(result string, table_bbox *string) *[][]string {
    ...
    var cTableBbox *C.char
    if table_bbox != nil {
        cTableBbox = C.CString(*table_bbox)
        defer C.free(unsafe.Pointer(cTableBbox))
    }

    ptr := C.kreuzberg_build_cell_grid(cResult, cTableBbox)
    return func() *[][]string {
	if ptr == nil { return nil }
	defer C.kreuzberg_free_string(ptr)
	var result [][]string
...
func TakeOrCreateTatr(accel *AccelerationConfig) **string {
    ...
    ptr := C.kreuzberg_take_or_create_tatr(cAccel)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func TakeOrCreateSlanet(variant string, accel *AccelerationConfig) **string {
    ...
    ptr := C.kreuzberg_take_or_create_slanet(cVariant, cAccel)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func TakeOrCreateTableClassifier(accel *AccelerationConfig) **string {
    jsonBytescAccel, err := json.Marshal(accel)
    if err != nil {
        panic(fmt.Sprintf("failed to marshal: %v", err))
    }
    ...
    ptr := C.kreuzberg_take_or_create_table_classifier(cAccel)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func ExtractMetadataWithPassword(pdf_bytes []byte, password *string) (*string, error) {
    ...
    ptr := C.kreuzberg_extract_metadata_with_password(cPdfBytes, cPassword)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_free_string(ptr)
        }
...
func RenderPdfPageToPng(pdf_bytes []byte, page_index uint, dpi *int32, password *string) (*[]byte, error) {
    ...
    ptr := C.kreuzberg_render_pdf_page_to_png(cPdfBytes, cPageIndex, cDpi, cPassword)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_free_string(ptr)
        }
...
func (r *ExtractionConfig) WithFileOverrides(overrides FileExtractionConfig) *ExtractionConfig {
    ...
    ptr := C.kreuzberg_extraction_config_with_file_overrides ((*C.KREUZBERGExtractionConfig)(unsafe.Pointer(r.ptr)), cOverrides)
    defer C.kreuzberg_extraction_config_free(ptr)
    return func() *ExtractionConfig {
	jsonPtr := C.kreuzberg_extraction_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *ExtractionConfig) Normalized() *ExtractionConfig {
    ptr := C.kreuzberg_extraction_config_normalized ((*C.KREUZBERGExtractionConfig)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_extraction_config_free(ptr)
    return func() *ExtractionConfig {
	jsonPtr := C.kreuzberg_extraction_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *ExtractionConfig) Validate() error {
    C.kreuzberg_extraction_config_validate ((*C.KREUZBERGExtractionConfig)(unsafe.Pointer(r.ptr)))
    return lastError()
}
...
func (r *ExtractionConfig) EffectiveDisableOcr() *bool {
    ptr := C.kreuzberg_extraction_config_effective_disable_ocr ((*C.KREUZBERGExtractionConfig)(unsafe.Pointer(r.ptr)))
    return func() *bool { v := ptr != 0; return &v }()
}
...
func (r *ExtractionConfig) NeedsImageProcessing() *bool {
    ptr := C.kreuzberg_extraction_config_needs_image_processing ((*C.KREUZBERGExtractionConfig)(unsafe.Pointer(r.ptr)))
    return func() *bool { v := ptr != 0; return &v }()
}
...
func (r *OcrConfig) Validate() error {
    C.kreuzberg_ocr_config_validate ((*C.KREUZBERGOcrConfig)(unsafe.Pointer(r.ptr)))
    return lastError()
}
...
func (r *OcrConfig) EffectiveThresholds() *OcrQualityThresholds {
    ptr := C.kreuzberg_ocr_config_effective_thresholds ((*C.KREUZBERGOcrConfig)(unsafe.Pointer(r.ptr)))
...
func (r *OcrConfig) EffectivePipeline() **OcrPipelineConfig {
    ptr := C.kreuzberg_ocr_config_effective_pipeline ((*C.KREUZBERGOcrConfig)(unsafe.Pointer(r.ptr)))
    return func() *OcrPipelineConfig {
	jsonPtr := C.kreuzberg_ocr_pipeline_config_to_json(ptr)
	if jsonPtr == nil { return nil }
	defer C.kreuzberg_free_string(jsonPtr)
	var result OcrPipelineConfig
	if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil { return nil }
	return &result
}()
}
...
func (r *PostProcessorConfig) BuildLookupSets() {
    C.kreuzberg_post_processor_config_build_lookup_sets ((*C.KREUZBERGPostProcessorConfig)(unsafe.Pointer(r.ptr)))
}
...
func (r *ChunkingConfig) WithChunkerType(chunker_type ChunkerType) *ChunkingConfig {
    ...
    ptr := C.kreuzberg_chunking_config_with_chunker_type ((*C.KREUZBERGChunkingConfig)(unsafe.Pointer(r.ptr)), cChunkerType)
...
func (r *ChunkingConfig) WithSizing(sizing ChunkSizing) *ChunkingConfig {
    ...
    ptr := C.kreuzberg_chunking_config_with_sizing ((*C.KREUZBERGChunkingConfig)(unsafe.Pointer(r.ptr)), cSizing)
    defer C.kreuzberg_chunking_config_free(ptr)
    return func() *ChunkingConfig {
	jsonPtr := C.kreuzberg_chunking_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *ChunkingConfig) WithPrependHeadingContext(prepend bool) *ChunkingConfig {
    ptr := C.kreuzberg_chunking_config_with_prepend_heading_context ((*C.KREUZBERGChunkingConfig)(unsafe.Pointer(r.ptr)), cPrepend)
    defer C.kreuzberg_chunking_config_free(ptr)
    return func() *ChunkingConfig {
	jsonPtr := C.kreuzberg_chunking_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *ChunkingConfig) WithTopicThreshold(threshold float32) *ChunkingConfig {
    ptr := C.kreuzberg_chunking_config_with_topic_threshold ((*C.KREUZBERGChunkingConfig)(unsafe.Pointer(r.ptr)), cThreshold)
    defer C.kreuzberg_chunking_config_free(ptr)
    return func() *ChunkingConfig {
	jsonPtr := C.kreuzberg_chunking_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *ServerConfig) ListenAddr() *string {
    ptr := C.kreuzberg_server_config_listen_addr ((*C.KREUZBERGServerConfig)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *ServerConfig) CorsAllowsAll() *bool {
    ptr := C.kreuzberg_server_config_cors_allows_all ((*C.KREUZBERGServerConfig)(unsafe.Pointer(r.ptr)))
    return func() *bool { v := ptr != 0; return &v }()
}
...
func (r *ServerConfig) IsOriginAllowed(origin string) *bool {
    ...
    ptr := C.kreuzberg_server_config_is_origin_allowed ((*C.KREUZBERGServerConfig)(unsafe.Pointer(r.ptr)), cOrigin)
    return func() *bool { v := ptr != 0; return &v }()
}
...
func (r *ServerConfig) MaxRequestBodyMb() *uint {
    ptr := C.kreuzberg_server_config_max_request_body_mb ((*C.KREUZBERGServerConfig)(unsafe.Pointer(r.ptr)))
    return func() *uint { v := uint(ptr); return &v }()
}
...
func (r *ServerConfig) MaxMultipartFieldMb() *uint {
    ptr := C.kreuzberg_server_config_max_multipart_field_mb ((*C.KREUZBERGServerConfig)(unsafe.Pointer(r.ptr)))
    return func() *uint { v := uint(ptr); return &v }()
}
...
func (r *ServerConfig) ApplyEnvOverrides() error {
    C.kreuzberg_server_config_apply_env_overrides ((*C.KREUZBERGServerConfig)(unsafe.Pointer(r.ptr)))
    return lastError()
}
...
func (r *StreamReader) ReadU8() (*uint8, error) {
    ptr := C.kreuzberg_stream_reader_read_u8 ((*C.KREUZBERGStreamReader)(unsafe.Pointer(r.ptr)))
    if err := lastError(); err != nil {
        return nil, err
    }
...
func (r *StreamReader) ReadU16() (*uint16, error) {
    ptr := C.kreuzberg_stream_reader_read_u16 ((*C.KREUZBERGStreamReader)(unsafe.Pointer(r.ptr)))
    if err := lastError(); err != nil {
        return nil, err
    }
...
func (r *StreamReader) ReadU32() (*uint32, error) {
    ptr := C.kreuzberg_stream_reader_read_u32 ((*C.KREUZBERGStreamReader)(unsafe.Pointer(r.ptr)))
    if err := lastError(); err != nil {
        return nil, err
    }
...
func (r *StreamReader) ReadBytes(len uint) (*[]byte, error) {
    ptr := C.kreuzberg_stream_reader_read_bytes ((*C.KREUZBERGStreamReader)(unsafe.Pointer(r.ptr)), cLen)
    if err := lastError(); err != nil {
        if ptr != nil {
            C.kreuzberg_free_string(ptr)
        }
...
func (r *StreamReader) Position() *uint64 {
    ptr := C.kreuzberg_stream_reader_position ((*C.KREUZBERGStreamReader)(unsafe.Pointer(r.ptr)))
    return func() *uint64 { v := uint64(ptr); return &v }()
}
...
func (r *StreamReader) Remaining() *uint {
    ptr := C.kreuzberg_stream_reader_remaining ((*C.KREUZBERGStreamReader)(unsafe.Pointer(r.ptr)))
    return func() *uint { v := uint(ptr); return &v }()
}
...
func (r *StringGrowthValidator) CheckAppend(len uint) error {
    C.kreuzberg_string_growth_validator_check_append ((*C.KREUZBERGStringGrowthValidator)(unsafe.Pointer(r.ptr)), cLen)
    return lastError()
}
...
func (r *StringGrowthValidator) CurrentSize() *uint {
    ptr := C.kreuzberg_string_growth_validator_current_size ((*C.KREUZBERGStringGrowthValidator)(unsafe.Pointer(r.ptr)))
    return func() *uint { v := uint(ptr); return &v }()
}
...
func (r *IterationValidator) CheckIteration() error {
    C.kreuzberg_iteration_validator_check_iteration ((*C.KREUZBERGIterationValidator)(unsafe.Pointer(r.ptr)))
    return lastError()
}
...
func (r *IterationValidator) CurrentCount() *uint {
    ptr := C.kreuzberg_iteration_validator_current_count ((*C.KREUZBERGIterationValidator)(unsafe.Pointer(r.ptr)))
    return func() *uint { v := uint(ptr); return &v }()
}
...
func (r *DepthValidator) Push() error {
    C.kreuzberg_depth_validator_push ((*C.KREUZBERGDepthValidator)(unsafe.Pointer(r.ptr)))
    return lastError()
}
...
func (r *DepthValidator) Pop() {
    C.kreuzberg_depth_validator_pop ((*C.KREUZBERGDepthValidator)(unsafe.Pointer(r.ptr)))
}


// Get current depth.
func (r *DepthValidator) CurrentDepth() *uint {
    ptr := C.kreuzberg_depth_validator_current_depth ((*C.KREUZBERGDepthValidator)(unsafe.Pointer(r.ptr)))
    return func() *uint { v := uint(ptr); return &v }()
}
...
func (r *EntityValidator) Validate(content string) error {
    ...
    C.kreuzberg_entity_validator_validate ((*C.KREUZBERGEntityValidator)(unsafe.Pointer(r.ptr)), cContent)
    return lastError()
}
...
func (r *TableValidator) AddCells(count uint) error {
    C.kreuzberg_table_validator_add_cells ((*C.KREUZBERGTableValidator)(unsafe.Pointer(r.ptr)), cCount)
    return lastError()
}
...
func (r *TableValidator) CurrentCells() *uint {
    ptr := C.kreuzberg_table_validator_current_cells ((*C.KREUZBERGTableValidator)(unsafe.Pointer(r.ptr)))
    return func() *uint { v := uint(ptr); return &v }()
}
...
func (r *DocumentStructure) PushNode(node DocumentNode) *uint32 {
    ...
    ptr := C.kreuzberg_document_structure_push_node ((*C.KREUZBERGDocumentStructure)(unsafe.Pointer(r.ptr)), cNode)
...
func (r *DocumentStructure) AddChild(parent uint32, child uint32) {
    C.kreuzberg_document_structure_add_child ((*C.KREUZBERGDocumentStructure)(unsafe.Pointer(r.ptr)), cParent, cChild)
}
...
func (r *DocumentStructure) Validate() error {
    C.kreuzberg_document_structure_validate ((*C.KREUZBERGDocumentStructure)(unsafe.Pointer(r.ptr)))
    return lastError()
}
...
func (r *DocumentStructure) BodyRoots() *string {
    ptr := C.kreuzberg_document_structure_body_roots ((*C.KREUZBERGDocumentStructure)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *DocumentStructure) FurnitureRoots() *string {
    ptr := C.kreuzberg_document_structure_furniture_roots ((*C.KREUZBERGDocumentStructure)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *DocumentStructure) Get(index uint32) **DocumentNode {
    ptr := C.kreuzberg_document_structure_get ((*C.KREUZBERGDocumentStructure)(unsafe.Pointer(r.ptr)), cIndex)
    return func() *DocumentNode {
	jsonPtr := C.kreuzberg_document_node_to_json(ptr)
	if jsonPtr == nil { return nil }
	defer C.kreuzberg_free_string(jsonPtr)
...
func (r *DocumentStructure) Len() *uint {
    ptr := C.kreuzberg_document_structure_len ((*C.KREUZBERGDocumentStructure)(unsafe.Pointer(r.ptr)))
    return func() *uint { v := uint(ptr); return &v }()
}
...
func (r *DocumentStructure) IsEmpty() *bool {
    ptr := C.kreuzberg_document_structure_is_empty ((*C.KREUZBERGDocumentStructure)(unsafe.Pointer(r.ptr)))
    return func() *bool { v := ptr != 0; return &v }()
}
...
func (r *HtmlMetadata) IsEmpty() *bool {
    ptr := C.kreuzberg_html_metadata_is_empty ((*C.KREUZBERGHtmlMetadata)(unsafe.Pointer(r.ptr)))
    return func() *bool { v := ptr != 0; return &v }()
}
...
func (r *OcrElement) WithLevel(level OcrElementLevel) *OcrElement {
    ...
    ptr := C.kreuzberg_ocr_element_with_level ((*C.KREUZBERGOcrElement)(unsafe.Pointer(r.ptr)), cLevel)
...
func (r *OcrElement) WithRotation(rotation OcrRotation) *OcrElement {
    ...
    ptr := C.kreuzberg_ocr_element_with_rotation ((*C.KREUZBERGOcrElement)(unsafe.Pointer(r.ptr)), cRotation)
    defer C.kreuzberg_ocr_element_free(ptr)
    return func() *OcrElement {
	jsonPtr := C.kreuzberg_ocr_element_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *OcrElement) WithPageNumber(page_number uint) *OcrElement {
    ptr := C.kreuzberg_ocr_element_with_page_number ((*C.KREUZBERGOcrElement)(unsafe.Pointer(r.ptr)), cPageNumber)
    defer C.kreuzberg_ocr_element_free(ptr)
    return func() *OcrElement {
	jsonPtr := C.kreuzberg_ocr_element_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *OcrElement) WithParentId(parent_id string) *OcrElement {
    ...
    ptr := C.kreuzberg_ocr_element_with_parent_id ((*C.KREUZBERGOcrElement)(unsafe.Pointer(r.ptr)), cParentId)
    defer C.kreuzberg_ocr_element_free(ptr)
    return func() *OcrElement {
	jsonPtr := C.kreuzberg_ocr_element_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *OcrElement) WithMetadata(key string, value map[string]interface{}) *OcrElement {
    ...
    ptr := C.kreuzberg_ocr_element_with_metadata ((*C.KREUZBERGOcrElement)(unsafe.Pointer(r.ptr)), cKey, cValue)
    defer C.kreuzberg_ocr_element_free(ptr)
    return func() *OcrElement {
	jsonPtr := C.kreuzberg_ocr_element_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *Uri) WithPage(page uint32) *Uri {
    ptr := C.kreuzberg_uri_with_page ((*C.KREUZBERGUri)(unsafe.Pointer(r.ptr)), cPage)
    defer C.kreuzberg_uri_free(ptr)
    return func() *Uri {
	jsonPtr := C.kreuzberg_uri_to_json(ptr)
	if jsonPtr == nil { return nil }
	defer C.kreuzberg_free_string(jsonPtr)
	var result Uri
	if err := json.Unmarshal([]byte(C.GoString(jsonPtr)), &result); err != nil { return nil }
...
func (r *PooledString) BufferMut() *string {
    ptr := C.kreuzberg_pooled_string_buffer_mut ((*C.KREUZBERGPooledString)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *PooledString) AsStr() *string {
    ptr := C.kreuzberg_pooled_string_as_str ((*C.KREUZBERGPooledString)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *PooledString) Deref() *string {
    ptr := C.kreuzberg_pooled_string_deref ((*C.KREUZBERGPooledString)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *PooledString) DerefMut() *string {
    ptr := C.kreuzberg_pooled_string_deref_mut ((*C.KREUZBERGPooledString)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *PooledString) Drop() {
    C.kreuzberg_pooled_string_drop ((*C.KREUZBERGPooledString)(unsafe.Pointer(r.ptr)))
}
...
func (r *PooledString) Fmt(f string) *string {
    ...
    ptr := C.kreuzberg_pooled_string_fmt ((*C.KREUZBERGPooledString)(unsafe.Pointer(r.ptr)), cF)
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *TracingLayer) Layer(inner string) *string {
    ...
    ptr := C.kreuzberg_tracing_layer_layer ((*C.KREUZBERGTracingLayer)(unsafe.Pointer(r.ptr)), cInner)
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *KeywordConfig) WithMaxKeywords(max uint) *KeywordConfig {
    ptr := C.kreuzberg_keyword_config_with_max_keywords ((*C.KREUZBERGKeywordConfig)(unsafe.Pointer(r.ptr)), cMax)
...
func (r *KeywordConfig) WithMinScore(score float32) *KeywordConfig {
    ptr := C.kreuzberg_keyword_config_with_min_score ((*C.KREUZBERGKeywordConfig)(unsafe.Pointer(r.ptr)), cScore)
    defer C.kreuzberg_keyword_config_free(ptr)
    return func() *KeywordConfig {
	jsonPtr := C.kreuzberg_keyword_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *KeywordConfig) WithNgramRange(min uint, max uint) *KeywordConfig {
    ptr := C.kreuzberg_keyword_config_with_ngram_range ((*C.KREUZBERGKeywordConfig)(unsafe.Pointer(r.ptr)), cMin, cMax)
    defer C.kreuzberg_keyword_config_free(ptr)
    return func() *KeywordConfig {
	jsonPtr := C.kreuzberg_keyword_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *KeywordConfig) WithLanguage(lang string) *KeywordConfig {
    ...
    ptr := C.kreuzberg_keyword_config_with_language ((*C.KREUZBERGKeywordConfig)(unsafe.Pointer(r.ptr)), cLang)
    defer C.kreuzberg_keyword_config_free(ptr)
    return func() *KeywordConfig {
	jsonPtr := C.kreuzberg_keyword_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *TessdataManager) CacheDir() *string {
    ptr := C.kreuzberg_tessdata_manager_cache_dir ((*C.KREUZBERGTessdataManager)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *TessdataManager) IsLanguageCached(lang string) *bool {
    ...
    ptr := C.kreuzberg_tessdata_manager_is_language_cached ((*C.KREUZBERGTessdataManager)(unsafe.Pointer(r.ptr)), cLang)
    return func() *bool { v := ptr != 0; return &v }()
}
...
func (r *PaddleOcrConfig) WithCacheDir(path string) *PaddleOcrConfig {
    ...
    ptr := C.kreuzberg_paddle_ocr_config_with_cache_dir ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cPath)
...
func (r *PaddleOcrConfig) WithTableDetection(enable bool) *PaddleOcrConfig {
    ptr := C.kreuzberg_paddle_ocr_config_with_table_detection ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cEnable)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *PaddleOcrConfig) WithAngleCls(enable bool) *PaddleOcrConfig {
    ptr := C.kreuzberg_paddle_ocr_config_with_angle_cls ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cEnable)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *PaddleOcrConfig) WithDetDbThresh(threshold float32) *PaddleOcrConfig {
    ptr := C.kreuzberg_paddle_ocr_config_with_det_db_thresh ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cThreshold)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *PaddleOcrConfig) WithDetDbBoxThresh(threshold float32) *PaddleOcrConfig {
    ptr := C.kreuzberg_paddle_ocr_config_with_det_db_box_thresh ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cThreshold)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *PaddleOcrConfig) WithDetDbUnclipRatio(ratio float32) *PaddleOcrConfig {
    ptr := C.kreuzberg_paddle_ocr_config_with_det_db_unclip_ratio ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cRatio)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *PaddleOcrConfig) WithDetLimitSideLen(length uint32) *PaddleOcrConfig {
    ptr := C.kreuzberg_paddle_ocr_config_with_det_limit_side_len ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cLength)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *PaddleOcrConfig) WithRecBatchNum(batch_size uint32) *PaddleOcrConfig {
    ptr := C.kreuzberg_paddle_ocr_config_with_rec_batch_num ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cBatchSize)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *PaddleOcrConfig) WithDropScore(score float32) *PaddleOcrConfig {
    ptr := C.kreuzberg_paddle_ocr_config_with_drop_score ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cScore)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *PaddleOcrConfig) WithPadding(padding uint32) *PaddleOcrConfig {
    ptr := C.kreuzberg_paddle_ocr_config_with_padding ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cPadding)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *PaddleOcrConfig) WithModelTier(tier string) *PaddleOcrConfig {
    ...
    ptr := C.kreuzberg_paddle_ocr_config_with_model_tier ((*C.KREUZBERGPaddleOcrConfig)(unsafe.Pointer(r.ptr)), cTier)
    defer C.kreuzberg_paddle_ocr_config_free(ptr)
    return func() *PaddleOcrConfig {
	jsonPtr := C.kreuzberg_paddle_ocr_config_to_json(ptr)
	if jsonPtr == nil { return nil }
...
func (r *BBox) Width() *float32 {
    ptr := C.kreuzberg_b_box_width ((*C.KREUZBERGBBox)(unsafe.Pointer(r.ptr)))
...
func (r *BBox) Height() *float32 {
    ptr := C.kreuzberg_b_box_height ((*C.KREUZBERGBBox)(unsafe.Pointer(r.ptr)))
    return func() *float32 { v := float32(ptr); return &v }()
}
...
func (r *BBox) Area() *float32 {
    ptr := C.kreuzberg_b_box_area ((*C.KREUZBERGBBox)(unsafe.Pointer(r.ptr)))
    return func() *float32 { v := float32(ptr); return &v }()
}
...
func (r *BBox) Center() *string {
    ptr := C.kreuzberg_b_box_center ((*C.KREUZBERGBBox)(unsafe.Pointer(r.ptr)))
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *BBox) IntersectionArea(other BBox) *float32 {
    ...
    ptr := C.kreuzberg_b_box_intersection_area ((*C.KREUZBERGBBox)(unsafe.Pointer(r.ptr)), cOther)
    return func() *float32 { v := float32(ptr); return &v }()
}
...
func (r *BBox) Iou(other BBox) *float32 {
    ...
    ptr := C.kreuzberg_b_box_iou ((*C.KREUZBERGBBox)(unsafe.Pointer(r.ptr)), cOther)
    return func() *float32 { v := float32(ptr); return &v }()
}
...
func (r *BBox) ContainmentOf(other BBox) *float32 {
    ...
    ptr := C.kreuzberg_b_box_containment_of ((*C.KREUZBERGBBox)(unsafe.Pointer(r.ptr)), cOther)
    return func() *float32 { v := float32(ptr); return &v }()
}
...
func (r *BBox) PageCoverage(page_width float32, page_height float32) *float32 {
    ptr := C.kreuzberg_b_box_page_coverage ((*C.KREUZBERGBBox)(unsafe.Pointer(r.ptr)), cPageWidth, cPageHeight)
    return func() *float32 { v := float32(ptr); return &v }()
}
...
func (r *BBox) Fmt(f string) *string {
    ...
    ptr := C.kreuzberg_b_box_fmt ((*C.KREUZBERGBBox)(unsafe.Pointer(r.ptr)), cF)
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
...
func (r *LayoutDetection) Fmt(f string) *string {
    ...
    ptr := C.kreuzberg_layout_detection_fmt ((*C.KREUZBERGLayoutDetection)(unsafe.Pointer(r.ptr)), cF)
    defer C.kreuzberg_free_string(ptr)
    return func() *string { v := C.GoString(ptr); return &v }()
}
