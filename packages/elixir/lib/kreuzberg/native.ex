...
defmodule Kreuzberg.Native do
  ...
  def is_markdown_header(_line), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def detect_plain_text_boundaries(_text), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def chunkingconfig_with_topic_threshold(_obj, _threshold),
    do: :erlang.nif_error(:nif_not_loaded)
