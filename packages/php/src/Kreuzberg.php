...
final class Kreuzberg
{
     ...
     * @return ExtractionResult
     */
    public static function applyOutputFormat(ExtractionResult $result, string $output_format): ExtractionResult
    {
    ...
    {
        return \Kreuzberg\KreuzbergApi::isMarkdownHeader($line); // delegate to native extension class
    }
     ...
     *
     * @param string $text
     * @return array<DetectedBoundary>
     */
    public static function detectPlainTextBoundaries(string $text): array
    {
        return \Kreuzberg\KreuzbergApi::detectPlainTextBoundaries($text); // delegate to native extension class
    }
     ...
     * @param array<bool> $boundaries
     * @param int $max_characters
     * @param int $overlap
     * @return array<MergedChunk>
     */
    public static function mergeSegments(string $source_text, array $segments, array $boundaries, int $max_characters, int $overlap): array
    {
        return \Kreuzberg\KreuzbergApi::mergeSegments($source_text, $segments, $boundaries, $max_characters, $overlap); // delegate to native extension class
    }
     ...
     * @return ?string
     */
    public static function takeOrCreateTatr(?AccelerationConfig $accel = null): ?string
    {
        return \Kreuzberg\KreuzbergApi::takeOrCreateTatr($accel); // delegate to native extension class
    }
     ...
     * @return ?string
     */
    public static function takeOrCreateSlanet(string $variant, ?AccelerationConfig $accel = null): ?string
    {
        return \Kreuzberg\KreuzbergApi::takeOrCreateSlanet($variant, $accel); // delegate to native extension class
    }
     ...
     * @return ?string
     */
    public static function takeOrCreateTableClassifier(?AccelerationConfig $accel = null): ?string
    {
        return \Kreuzberg\KreuzbergApi::takeOrCreateTableClassifier($accel); // delegate to native extension class
    }
