...
class KreuzbergApi
{
    ...
    public static function applyOutputFormat(\Kreuzberg\ExtractionResult $result, string $output_format): \Kreuzberg\ExtractionResult { }
    ...
    public static function generateElementId(string $text, \Kreuzberg\ElementType $element_type, ?int $page_number = null): string { }
     ...
     * @param int $overlap
     * @return array<\Kreuzberg\MergedChunk>
     */
    ...
    public static function takeOrCreateTatr(?\Kreuzberg\AccelerationConfig $accel = null): ?string { }
    public static function returnTatr(string $model): void { }
    public static function takeOrCreateSlanet(string $variant, ?\Kreuzberg\AccelerationConfig $accel = null): ?string { }
    public static function returnSlanet(string $variant, string $model): void { }
    public static function takeOrCreateTableClassifier(?\Kreuzberg\AccelerationConfig $accel = null): ?string { }
