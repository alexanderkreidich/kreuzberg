...
class StructuredDataResult:
    """Wrapper for StructuredDataResult."""
    content: str
    format: str
...
class OcrFallbackDecision:
    """Wrapper for OcrFallbackDecision."""
    stats: str
...
class TokenReductionConfig:
    """Wrapper for TokenReductionConfig."""
...
def apply_output_format(result: ExtractionResult, output_format: str) -> ExtractionResult: ...
...
def assign_hierarchy_levels(blocks: list[str], kmeans_result: str) -> list[HierarchyBlock]: ...
