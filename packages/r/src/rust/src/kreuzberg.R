...
#' @export
is_markdown_header <- function(line) {
  .Call("kreuzberg_is_markdown_header", line)
}
...
#' @export
detect_plain_text_boundaries <- function(text) {
  .Call("kreuzberg_detect_plain_text_boundaries", text)
}
...
#' @export
merge_segments <- function(source_text, segments, boundaries, max_characters, overlap) {
  .Call("kreuzberg_merge_segments", source_text, segments, boundaries, max_characters, overlap)
}
...
#' @export
take_or_create_tatr <- function(accel = NULL) {
  .Call("kreuzberg_take_or_create_tatr", accel)
}
...
#' @export
take_or_create_slanet <- function(variant, accel = NULL) {
  .Call("kreuzberg_take_or_create_slanet", variant, accel)
}
...
#' @export
take_or_create_table_classifier <- function(accel = NULL) {
  .Call("kreuzberg_take_or_create_table_classifier", accel)
}
