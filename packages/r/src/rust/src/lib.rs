...
impl PostProcessorConfig {
    ...
    pub fn build_lookup_sets(&self) -> Self {
...
impl ChunkingConfig {
    ...
    pub fn with_topic_threshold(&self, threshold: f64) -> ChunkingConfig {
        let core_self = kreuzberg::ChunkingConfig {
            max_characters: self.max_characters,
            overlap: self.overlap,
            trim: self.trim,
...
impl ServerConfig {
    ...
    pub fn apply_env_overrides(&self) -> Result<Self> {
        ...
        core_self.apply_env_overrides().map_err(|e| e.to_string())?;
        Ok(core_self.into())
    }
...
impl StreamReader {
    #[allow(clippy::missing_errors_doc)]
    pub fn read_u8(&self) -> Result<Self> {
        let mut core_self = kreuzberg::extraction::hwp::reader::StreamReader {
        };
        core_self.read_u8().map_err(|e| e.to_string())?;
        Ok(core_self.into())
    }

    #[allow(clippy::missing_errors_doc)]
    pub fn read_u16(&self) -> Result<Self> {
        let mut core_self = kreuzberg::extraction::hwp::reader::StreamReader {
        };
        core_self.read_u16().map_err(|e| e.to_string())?;
        Ok(core_self.into())
    }

    #[allow(clippy::missing_errors_doc)]
    pub fn read_u32(&self) -> Result<Self> {
        let mut core_self = kreuzberg::extraction::hwp::reader::StreamReader {
        };
        core_self.read_u32().map_err(|e| e.to_string())?;
        Ok(core_self.into())
    }

    #[allow(clippy::missing_errors_doc)]
    pub fn read_bytes(&self, len: f64) -> Result<Self> {
        let mut core_self = kreuzberg::extraction::hwp::reader::StreamReader {
        };
        core_self.read_bytes(len).map_err(|e| e.to_string())?;
        Ok(core_self.into())
    }
...
impl StringGrowthValidator {
    #[allow(clippy::missing_errors_doc)]
    pub fn check_append(&self, len: f64) -> Result<Self> {
        let mut core_self = kreuzberg::extractors::security::StringGrowthValidator {
        };
        core_self.check_append(len).map_err(|e| e.to_string())?;
        Ok(core_self.into())
    }
...
impl IterationValidator {
    #[allow(clippy::missing_errors_doc)]
    pub fn check_iteration(&self) -> Result<Self> {
        let mut core_self = kreuzberg::extractors::security::IterationValidator {
        };
        core_self.check_iteration().map_err(|e| e.to_string())?;
        Ok(core_self.into())
    }
...
impl DepthValidator {
    #[allow(clippy::missing_errors_doc)]
    pub fn push(&self) -> Result<Self> {
        let mut core_self = kreuzberg::extractors::security::DepthValidator {
        };
        core_self.push().map_err(|e| e.to_string())?;
        Ok(core_self.into())
    }
...
impl TableValidator {
    #[allow(clippy::missing_errors_doc)]
    pub fn add_cells(&self, count: f64) -> Result<Self> {
        let mut core_self = kreuzberg::extractors::security::TableValidator {
        };
        core_self.add_cells(count).map_err(|e| e.to_string())?;
        Ok(core_self.into())
    }
...
impl DocumentStructure {
    ...
    pub fn push_node(&self, node: DocumentNode) -> Self {
        ...
        core_self.push_node(node.into());
        core_self.into()
    }

    pub fn add_child(&self, parent: i32, child: i32) -> Self {
        let mut core_self = kreuzberg::DocumentStructure {
            nodes: self.nodes.clone().into_iter().map(Into::into).collect(),
            source_format: self.source_format.clone(),
            relationships: self.relationships.clone().into_iter().map(Into::into).collect(),
...
pub fn detect_plain_text_boundaries(text: String) -> Vec<DetectedBoundary> {
    kreuzberg::chunking::boundary_detection::detect_plain_text_boundaries(&text).into_iter().map(Into::into).collect()
}
...
#[extendr]
pub fn merge_segments(source_text: String, segments: Vec<String>, boundaries: Vec<bool>, max_characters: f64, overlap: f64) -> Vec<MergedChunk> {
...
pub fn chunk_semantic(text: String, config: ChunkingConfig, page_boundaries: Option<Vec<PageBoundary>>) -> Result<ChunkingResult> {
    let config_core: kreuzberg::ChunkingConfig = config.into();
    let page_boundaries_core: Option<Vec<_>> = page_boundaries.as_ref().map(|v| v.iter().map(|x| x.clone().into()).collect());
    kreuzberg::chunking::semantic::chunk_semantic(&text, &config_core, page_boundaries_core.as_deref()).map(|val| val.into()).map_err(|e| e.to_string())
}
...
#[extendr]
pub fn apply_heuristics(detections: Vec<LayoutDetection>, page_width: f64, page_height: f64) -> Vec<LayoutDetection> {
    let detections_core: Vec<_> = detections.into_iter().map(Into::into).collect();
    kreuzberg::layout::postprocessing::heuristics::apply_heuristics(detections_core, page_width, page_height).into_iter().map(Into::into).collect()
}

#[extendr]
pub fn greedy_nms(detections: Vec<LayoutDetection>, iou_threshold: f64) -> Vec<LayoutDetection> {
    let detections_core: Vec<_> = detections.into_iter().map(Into::into).collect();
    kreuzberg::layout::postprocessing::nms::greedy_nms(detections_core, iou_threshold).into_iter().map(Into::into).collect()
}
...
extendr_module! {
    ...
    fn detect_plain_text_boundaries;
    fn classify_chunk;
    fn chunk_text;
