...
## Python API Reference <span class="version-badge">v4.9.1</span>
...
```python
def cleanup_cache(cache_dir: str, max_age_days: float, max_size_mb: float, target_size_ratio: float) -> UsizeF64
```
...
```python
def smart_cleanup_cache(cache_dir: str, max_age_days: float, max_size_mb: float, min_free_space_mb: float) -> UsizeF64
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `cache_path` | `str` | Yes | The cache path |
| `max_age_days` | `float` | Yes | The max age days |
...
```python
def clear_cache_directory(cache_dir: str) -> UsizeF64
```
...
```python
def batch_cleanup_caches(cache_dirs: list[str], max_age_days: float, max_size_mb: float, min_free_space_mb: float) -> list[UsizeF64]
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `cache_dirs` | `list[str]` | Yes | The cache dirs |
| `max_age_days` | `float` | Yes | The max age days |
| `max_size_mb` | `float` | Yes | The max size mb |
| `min_free_space_mb` | `float` | Yes | The min free space mb |
...
```python
def generate_cache_key(parts: list[StrStr]) -> str
```
...
```python
def sort_cache_by_access_time(entries: list[StringF64]) -> list[str]
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `namespace` | `str` | Yes | The namespace |
...
```python
def build_config_from_json(base: ExtractionConfig, override_json: str = None) -> ExtractionConfig
```
...
|------|------|----------|-------------|
| `base` | `ExtractionConfig` | Yes | The extraction config |
| `override_json` | `str | None` | No | The override json |
...
```python
def validate_vlm_backend_config(backend: str, vlm_config: LlmConfig = None) -> None
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `backend` | `str` | Yes | The OCR backend name |
| `vlm_config` | `LlmConfig | None` | No | The optional VLM config to validate |
...
```python
def validate_structured_extraction_schema(schema: Any, llm_model: str) -> None
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `schema` | `Any` | Yes | The JSON schema value to validate |
| `llm_model` | `str` | Yes | The LLM model string from the nested `LlmConfig` |
...
```python
def extract_file(path: Path, mime_type: str = None, config: ExtractionConfig) -> ExtractionResult
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `file_size` | `int` | Yes | The file size |
...
```python
def apply_output_format(result: ExtractionResult, output_format: OutputFormat) -> ExtractionResult
```
...
```python
def run_pipeline(doc: InternalDocument, config: ExtractionConfig) -> ExtractionResult
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `text` | `str` | Yes | The text to search for list items |
...
```python
def generate_element_id(text: str, element_type: ElementType, page_number: int = None) -> ElementId
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `text` | `str` | Yes | The element text content |
| `element_type` | `ElementType` | Yes | The semantic element type |
| `page_number` | `int | None` | No | Optional page number for multi-page documents |
...
```python
def decompress_gzip(bytes: bytes, limits: SecurityLimits) -> bytes
```
...
```python
def extract_gzip(bytes: bytes, limits: SecurityLimits) -> ArchiveMetadataAHashMapStringString
```
...
```python
def extract_gzip_metadata(bytes: bytes, limits: SecurityLimits) -> ArchiveMetadata
```
...
```python
def extract_gzip_text_content(bytes: bytes, limits: SecurityLimits) -> AHashMap
```
...
```python
def extract_gzip_with_bytes(bytes: bytes, limits: SecurityLimits) -> GzipWithBytesResult
```
...
```python
def extract_7z_metadata(bytes: bytes, limits: SecurityLimits) -> ArchiveMetadata
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `bytes` | `bytes` | Yes | The 7z archive bytes |
...
```python
def extract_7z_text_content(bytes: bytes, limits: SecurityLimits) -> AHashMap
```
...
```python
def extract_7z_file_bytes(bytes: bytes, limits: SecurityLimits) -> AHashMap
```
...
```python
def extract_tar_metadata(bytes: bytes, limits: SecurityLimits) -> ArchiveMetadata
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `bytes` | `bytes` | Yes | The TAR archive bytes (can be compressed with gzip or bzip2) |
| `limits` | `SecurityLimits` | Yes | Security limits for archive extraction |
...
```python
def extract_tar_text_content(bytes: bytes, limits: SecurityLimits) -> AHashMap
```
...
```python
def extract_tar_file_bytes(bytes: bytes, limits: SecurityLimits) -> AHashMap
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `bytes` | `bytes` | Yes | The TAR archive bytes |
| `limits` | `SecurityLimits` | Yes | Security limits for archive extraction |
...
```python
def extract_zip_metadata(bytes: bytes, limits: SecurityLimits) -> ArchiveMetadata
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `bytes` | `bytes` | Yes | The ZIP archive bytes |
| `limits` | `SecurityLimits` | Yes | Security limits for archive extraction |
...
```python
def extract_zip_text_content(bytes: bytes, limits: SecurityLimits) -> AHashMap
```
...
```python
def extract_zip_file_bytes(bytes: bytes, limits: SecurityLimits) -> AHashMap
```
...
```python
def convert_html_to_markdown(html: str, options: ConversionOptions = None, output_format: KreuzbergOutputFormat = None) -> str
```
...
| `options` | `ConversionOptions | None` | No | Optional conversion options; defaults will be used if None |
| `output_format` | `KreuzbergOutputFormat | None` | No | Optional output format; defaults to Markdown if None |
...
```python
def convert_html_to_markdown_with_metadata(html: str, options: ConversionOptions = None, output_format: KreuzbergOutputFormat = None) -> StringOptionHtmlMetadata
```
...
```python
def convert_html_to_markdown_with_tables(html: str, options: ConversionOptions = None, output_format: KreuzbergOutputFormat = None) -> DocumentStructure
```
...
| `output_format` | `KreuzbergOutputFormat | None` | No | The kreuzberg output format |
...
```python
def extract_html_inline_images(html: str, options: ConversionOptions = None) -> list[InlineImage]
```
...
```python
def extract_ooxml_embedded_objects(zip_bytes: bytes, embeddings_prefix: str, source_label: str, config: ExtractionConfig) -> VecArchiveEntryVecProcessingWarning
```
...
```python
def extract_complete_djot_content(events: list[Event], metadata: Metadata, tables: list[Table]) -> DjotContent
```
...
```python
def extract_tables_from_events(events: list[Event]) -> list[Table]
```
...
```python
def extract_text_from_events(events: list[Event]) -> str
```
...
```python
def parse_rtf_control_word(chars: Peekable) -> StringOptionI32
```
...
```python
def extract_pict_image(chars: Peekable) -> StringOptionRtfImage
```
...
```python
def extract_rtf_metadata(rtf_content: str, extracted_text: str) -> AHashMap
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `rtf_content` | `str` | Yes | The rtf content |
| `extracted_text` | `str` | Yes | The extracted text |
...
```python
def spans_to_annotations(para_start: int, para_end: int, formatting: RtfFormattingData) -> list[TextAnnotation]
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `para_start` | `int` | Yes | The para start |
| `para_end` | `int` | Yes | The para end |
...
```python
def extract_text_from_rtf(content: str, plain: bool) -> StringVecTableVecRtfImageVecParagraphMetaRtfFormattingData
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `name` | `str` | Yes | Name of the extractor to unregister |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `name` | `str` | Yes | Name of the renderer to unregister |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `name` | `str` | Yes | Name of the validator to unregister |
...
```python
def render_djot(doc: InternalDocument) -> str
```
...
```python
def render_html(doc: InternalDocument) -> str
```
...
```python
def render_json(doc: InternalDocument) -> str
```
...
```python
def render_markdown(doc: InternalDocument) -> str
```
...
```python
def render_plain(doc: InternalDocument) -> str
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `lang_code` | `str` | Yes | The language code to intern (e.g., "en", "es", "fr") |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `mime_type` | `str` | Yes | The MIME type string to intern |
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `config_path` | `str | None` | No | Optional path to a ServerConfig file (TOML, YAML, or JSON) |
...
```python
def create_router(config: ExtractionConfig) -> Router
```
...
```python
def create_router_with_limits(config: ExtractionConfig, limits: ApiSizeLimits) -> Router
```
...
```python
def create_router_with_limits_and_server_config(config: ExtractionConfig, limits: ApiSizeLimits, server_config: ServerConfig) -> Router
```
...
```python
def map_kreuzberg_error_to_mcp(error: KreuzbergError) -> McpError
```
...
```python
def detect_plain_text_boundaries(text: str) -> list[DetectedBoundary]
```
...
```python
def merge_segments(source_text: str, segments: list[Segment], boundaries: list[bool], max_characters: int, overlap: int) -> list[MergedChunk]
```
...
```python
def detect_topic_boundaries(segment_texts: list[str], forced_boundaries: list[bool], embedding_config: EmbeddingConfig, threshold: float) -> list[bool]
```
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| `segment_texts` | `list[str]` | Yes | The segment texts |
| `forced_boundaries` | `list[bool]` | Yes | The forced boundaries |
...
```python
def extract_structured(content: str, config: StructuredExtractionConfig) -> LlmUsage
```
...
```python
def vlm_ocr(image_bytes: bytes, image_mime_type: str, language: str, config: LlmConfig) -> LlmUsage
```
...
```python
def preset_chunk_size(name: str) -> int | None
```
...
```python
def apply_heuristics(detections: list[LayoutDetection], page_width: float, page_height: float) -> list[LayoutDetection]
```
...
```python
def greedy_nms(detections: list[LayoutDetection], iou_threshold: float) -> list[LayoutDetection]
```
...
```python
def take_or_create_tatr(accel: AccelerationConfig = None) -> TatrModel | None
```
...
```python
def take_or_create_slanet(variant: str, accel: AccelerationConfig = None) -> SlanetModel | None
```
...
```python
def take_or_create_table_classifier(accel: AccelerationConfig = None) -> TableClassifier | None
```
...
```python
def extract_and_process_embedded_files(pdf_bytes: bytes, config: ExtractionConfig) -> VecArchiveEntryVecProcessingWarning
```
...
```python
def assign_heading_levels_smart(clusters: list[FontSizeCluster], min_heading_ratio: float, min_heading_gap: float) -> list[F32OptionU8]
```
...
```python
def assign_hierarchy_levels(blocks: list[TextBlock], kmeans_result: KMeansResult) -> list[HierarchyBlock]
```
...
```python
def assign_hierarchy_levels_from_clusters(blocks: list[TextBlock], clusters: list[FontSizeCluster]) -> list[TextBlockHierarchyLevel]
```
...
```python
def extract_chars_with_fonts(page: PdfPage) -> list[CharData]
```
...
```python
def extract_segments_from_page(page: PdfPage) -> list[SegmentData]
```
...
```python
def should_trigger_ocr(page: PdfPage, blocks: list[TextBlock], config: ExtractionConfig) -> bool
```
...
```python
@staticmethod
def validation(error: KreuzbergError) -> ApiError
```
...
```python
@staticmethod
def unprocessable(error: KreuzbergError) -> ApiError
```
...
```python
@staticmethod
def internal(error: KreuzbergError) -> ApiError
```
...
```python
@staticmethod
def bad_gateway(error: KreuzbergError) -> ApiError
```
...
```python
@staticmethod
def from(error: KreuzbergError) -> ApiError
```
...
| `config` | `Any | None` | `None` | Extraction configuration (JSON object) |
| `pdf_password` | `str | None` | `None` | Password for encrypted PDFs |
| `file_configs` | `list[Any | None] | None` | `None` | Per-file extraction configuration overrides (parallel array to paths). Each entry is either null (use default) or a FileExtractionConfig JSON object. |
...
| `config` | `ChunkingConfigRequest | None` | `None` | Optional chunking configuration |
...
```python
def with_topic_threshold(self, threshold: float) -> ChunkingConfig
```
...
```python
@staticmethod
def with_acceleration(cache_dir: str, accel: AccelerationConfig) -> DocOrientationDetector
```
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `md_content` | `str` | — | Markdown content of the converted document |
...
| `description` | `str | None` | `None` | Human-readable description |
| `dimensions` | `U32U32 | None` | `None` | Dimensions ((u32, u32)) |
...
```python
def poll_ready(self, cx: Context) -> Poll
```
...
```python
def call(self, req: ExtractionRequest) -> Future
```
...
| `plugins` | `PluginStatus | None` | `None` | Plugin status (optional) |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `labels` | `list[int]` | — | Cluster label for each block (0-indexed) |
...
```python
def ensure_rtdetr_model(self) -> str
```
...
```python
def is_rtdetr_cached(self) -> bool
```
...
```python
def ensure_tatr_model(self) -> str
```
...
```python
def ensure_slanet_model(self, variant: str) -> str
```
...
```python
def ensure_table_classifier(self) -> str
```
...
```python
@staticmethod
def manifest() -> list[ModelManifestEntry]
```
...
| `byte_start` | `int` | — | Starting byte offset in the content string |
| `byte_end` | `int` | — | Ending byte offset in the content string |
| `indent_level` | `int` | — | List item indent level |
...
```python
def ensure_rec_model(self, family: str) -> RecModelPaths
```
...
```python
def ensure_models_exist(self) -> ModelPaths
```
...
```python
def are_shared_models_cached(self) -> bool
```
...
```python
def is_rec_model_cached(self, family: str) -> bool
```
...
```python
def ensure_v2_det_model(self, tier: str) -> str
```
...
```python
def ensure_v2_cls_model(self) -> str
```
...
```python
def ensure_doc_ori_model(self) -> str
```
...
```python
def ensure_shared_models(self, tier: str) -> SharedModelPaths
```
...
```python
def resolve_rec_model(self, family: str, tier: str) -> ResolvedRecModel
```
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `relative_path` | `str` | — | Relative path within the cache directory (e.g., "paddle-ocr/det/model.onnx"). |
| `sha256` | `str` | — | SHA256 checksum of the model file. |
| `size_bytes` | `int` | — | Expected file size in bytes. |
| `source_url` | `str` | — | HuggingFace source URL for downloading. |
...
```python
@staticmethod
def from(text: str) -> NativeTextStats
```
...
```python
@staticmethod
def with_config(config: PaddleOcrConfig) -> PaddleOcrBackend
```
...
```python
def register(self, processor: PostProcessor, priority: int) -> None
```
...
```python
def get_for_stage(self, stage: ProcessingStage) -> list[PostProcessor]
```
...
```python
def render(self, name: str, doc: InternalDocument) -> str
```
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `model_dir` | `str` | — | Directory containing model.onnx. |
| `dict_file` | `str` | — | Path to the character dictionary file. |
| `model_key` | `str` | — | Engine pool key for sharing engines across script families. Multiple families may share the same key (e.g. chinese and japanese both map to "v2:unified_server" when using server tier). |
...
```python
@staticmethod
def from_file(path: str, accel: AccelerationConfig) -> RtDetrModel
```
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `text` | `str` | — | The segment text content (may contain spaces / multiple words) |
...
| `assigned_role` | `int | None` | `None` | Pre-assigned heading level from the PDF structure tree (1-6), or `None` when the heading level is unknown and must be inferred via font-size clustering. |
...
```python
@staticmethod
def from_file(path: str, accel: AccelerationConfig) -> SlanetModel
```
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `total_acquires` | `int` | — | Total number of acquire calls |
| `total_reuses` | `int` | — | Total number of buffer reuses from pool |
...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `structured_output` | `Any` | — | Structured data conforming to the provided JSON schema |
...
```python
@staticmethod
def from_file(path: str, accel: AccelerationConfig) -> TableClassifier
```
...
```python
@staticmethod
def from_file(path: str, accel: AccelerationConfig) -> TatrModel
```
...
```python
@staticmethod
def new(config: TokenReductionConfig, language_hint: str) -> TokenReducer
```
...
```python
@staticmethod
def from_file(path: str, variant: YoloVariant, input_width: int, input_height: int, model_name: str, accel: AccelerationConfig) -> YoloModel
```
...
| Value | Description |
|-------|-------------|
| `INVALID_FORMAT` | The file does not match the HWP 5.0 format. — Fields: `0`: `str` |
| `UNSUPPORTED_VERSION` | The HWP version or a feature is not supported (e.g. password-encrypted docs). — Fields: `0`: `str` |
| `IO` | An underlying I/O error occurred. — Fields: `0`: `Error` |
| `CFB` | A CFB compound-file error (stream not found, corrupt container, etc.). — Fields: `0`: `str` |
| `COMPRESSION_ERROR` | Decompression of a zlib/deflate stream failed. — Fields: `0`: `str` |
| `PARSE_ERROR` | The binary record stream could not be parsed. — Fields: `0`: `str` |
| `ENCODING_ERROR` | A UTF-16LE string contained invalid data. — Fields: `0`: `str` |
| `NOT_FOUND` | A requested stream was not present in the compound file. — Fields: `0`: `str` |
...
| Value | Description |
|-------|-------------|
| `RUN` | Plain text from m:r/m:t — Fields: `0`: `str` |
...
| `RAD` | Radical: \sqrt{body} or \sqrt[deg]{body} — Fields: `deg`: `list[MathNode]`, `body`: `list[MathNode]`, `deg_hide`: `bool` |
| `NARY` | N-ary operator: \sum_{sub}^{sup}{body} — Fields: `chr`: `str`, `sub`: `list[MathNode]`, `sup`: `list[MathNode]`, `body`: `list[MathNode]`, `sub_hide`: `bool`, `sup_hide`: `bool` |
| `DELIM` | Delimiter: \left( ... \right) — Fields: `begin_chr`: `str`, `end_chr`: `str`, `sep_chr`: `str`, `elements`: `list[list[MathNode]]` |
| `FUNC` | Function: \funcname{body} — Fields: `name`: `list[MathNode]`, `body`: `list[MathNode]` |
| `ACC` | Accent: \hat{body} — Fields: `chr`: `str`, `body`: `list[MathNode]` |
...
| Value | Description |
|-------|-------------|
| `RGB` | Direct hex RGB color (e.g., "156082"). — Fields: `0`: `str` |
| `SYSTEM` | System color with fallback RGB (e.g., "windowText" with lastClr "000000"). — Fields: `name`: `str`, `last_color`: `str` |
...
| Value | Description |
|-------|-------------|
| `ZIP_BOMB_DETECTED` | Potential ZIP bomb detected — Fields: `compressed_size`: `int`, `uncompressed_size`: `int`, `ratio`: `float` |
| `ARCHIVE_TOO_LARGE` | Archive exceeds maximum size — Fields: `size`: `int`, `max`: `int` |
| `TOO_MANY_FILES` | Archive contains too many files — Fields: `count`: `int`, `max`: `int` |
| `NESTING_TOO_DEEP` | Nesting too deep — Fields: `depth`: `int`, `max`: `int` |
| `CONTENT_TOO_LARGE` | Content exceeds maximum size — Fields: `size`: `int`, `max`: `int` |
| `ENTITY_TOO_LONG` | Entity/string too long — Fields: `length`: `int`, `max`: `int` |
| `TOO_MANY_ITERATIONS` | Too many iterations — Fields: `count`: `int`, `max`: `int` |
| `XML_DEPTH_EXCEEDED` | XML depth exceeded — Fields: `depth`: `int`, `max`: `int` |
| `TOO_MANY_CELLS` | Too many table cells — Fields: `cells`: `int`, `max`: `int` |
...
| `LIST_ITEM` | List item. `ordered` indicates numbered vs bulleted. — Fields: `ordered`: `bool` |
...
| `LIST_START` | Start of a list container. — Fields: `ordered`: `bool` |
...
| `TABLE` | Table reference. `table_index` is an index into `InternalDocument.tables`. — Fields: `table_index`: `int` |
| `IMAGE` | Image reference. `image_index` is an index into `InternalDocument.images`. — Fields: `image_index`: `int` |
| `PAGE_BREAK` | Page break marker. |
...
| `KEY` | Unresolved: key to be matched against element anchors during derivation. — Fields: `0`: `str` |
...
| Value | Description |
|-------|-------------|
| `FILE` | Extract from a filesystem path with an optional MIME type hint. — Fields: `path`: `str`, `mime_hint`: `str` |
| `BYTES` | Extract from in-memory bytes with a known MIME type. — Fields: `data`: `bytes`, `mime_type`: `str` |
...
| Value | Description |
|-------|-------------|
| `TOKENIZER` | Tokenizer — Fields: `0`: `str` |
| `ORT` | Ort — Fields: `0`: `Error` |
| `SHAPE` | Shape — Fields: `0`: `str` |
| `NO_OUTPUT` | No output |
...
| Value | Description |
|-------|-------------|
| `TESSERACT_INITIALIZATION_FAILED` | Tesseract initialization failed — Fields: `0`: `str` |
| `UNSUPPORTED_VERSION` | Unsupported version — Fields: `0`: `str` |
| `INVALID_CONFIGURATION` | Invalid configuration — Fields: `0`: `str` |
| `INVALID_LANGUAGE_CODE` | Invalid language code — Fields: `0`: `str` |
| `IMAGE_PROCESSING_FAILED` | Image processing failed — Fields: `0`: `str` |
| `PROCESSING_FAILED` | Processing failed — Fields: `0`: `str` |
| `CACHE_ERROR` | Cache error — Fields: `0`: `str` |
| `IO_ERROR` | I o error — Fields: `0`: `str` |
...
| `CUSTOM` | Custom model from a local file path. — Fields: `path`: `str`, `variant`: `CustomModelVariant` |
...
| `YOLOX` | Yolox — Fields: `input_width`: `int`, `input_height`: `int` |
...
| Value | Description |
|-------|-------------|
| `INVALID_PDF` | Invalid pdf — Fields: `0`: `str` |
| `PASSWORD_REQUIRED` | Password required |
| `INVALID_PASSWORD` | Invalid password |
| `ENCRYPTION_NOT_SUPPORTED` | Encryption not supported — Fields: `0`: `str` |
| `PAGE_NOT_FOUND` | Page not found — Fields: `0`: `int` |
| `TEXT_EXTRACTION_FAILED` | Text extraction failed — Fields: `0`: `str` |
| `RENDERING_FAILED` | Rendering failed — Fields: `0`: `str` |
| `METADATA_EXTRACTION_FAILED` | Metadata extraction failed — Fields: `0`: `str` |
| `EXTRACTION_FAILED` | Extraction failed — Fields: `0`: `str` |
| `FONT_LOADING_FAILED` | Font loading failed — Fields: `0`: `str` |
| `IO_ERROR` | I o error — Fields: `0`: `str` |
...
**Base class:** `LayoutError(Exception)`

| Exception | Description |
|-----------|-------------|
| `Ort(LayoutError)` | ORT error: {0} |
| `Image(LayoutError)` | Image error: {0} |
| `SessionNotInitialized(LayoutError)` | Session not initialized |
| `InvalidOutput(LayoutError)` | Invalid model output: {0} |
| `ModelDownload(LayoutError)` | Model download failed: {0} |
