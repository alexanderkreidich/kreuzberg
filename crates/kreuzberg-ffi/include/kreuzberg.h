 ...
 * Returned pointers must be freed with the appropriate free function.
 */
KREUZBERGChunkingConfig *kreuzberg_chunking_config_with_topic_threshold(KREUZBERGChunkingConfig *this_,
                                                                        float threshold);
 ...
 * Returned pointers must be freed with the appropriate free function.
 */
KREUZBERGExtractionResult *kreuzberg_apply_output_format(const KREUZBERGExtractionResult *_result,
 ...
 * Returned pointers must be freed with the appropriate free function.
 */
int32_t kreuzberg_is_markdown_header(const char *line);
 ...
 * Returned pointers must be freed with the appropriate free function.
 */
char *kreuzberg_detect_plain_text_boundaries(const char *text);
 ...
 * Returned pointers must be freed with the appropriate free function.
 */
char *kreuzberg_merge_segments(const char *_source_text,
                               const char *_segments,
                               const char *_boundaries,
                               uintptr_t _max_characters,
                               uintptr_t _overlap);
 ...
 * Returned pointers must be freed with the appropriate free function.
 */
char *kreuzberg_apply_heuristics(const char *detections,
                                 float page_width,
                                 float page_height);
 ...
 * Returned pointers must be freed with the appropriate free function.
 */
char *kreuzberg_take_or_create_tatr(const KREUZBERGAccelerationConfig *_accel);
 ...
 * Returned pointers must be freed with the appropriate free function.
 */
char *kreuzberg_take_or_create_table_classifier(const KREUZBERGAccelerationConfig *_accel);
