...
impl ChunkingConfig {
    ...
    pub fn with_topic_threshold(&self, threshold: f32) -> ChunkingConfig {
        ...
        core_self.with_topic_threshold(threshold).into()
    }
...
impl StreamReader {
    pub fn read_u8(&self) -> PhpResult<u8> {
        Err(ext_php_rs::exception::PhpException::default(
            "Not implemented: read_u8".to_string(),
        ))
    }

    pub fn read_u16(&self) -> PhpResult<u16> {
        Err(ext_php_rs::exception::PhpException::default(
            "Not implemented: read_u16".to_string(),
        ))
    }

    pub fn read_u32(&self) -> PhpResult<u32> {
        Err(ext_php_rs::exception::PhpException::default(
            "Not implemented: read_u32".to_string(),
        ))
    }
...
impl IterationValidator {
    pub fn check_iteration(&self) -> PhpResult<()> {
        Err(ext_php_rs::exception::PhpException::default(
            "Not implemented: check_iteration".to_string(),
        ))
    }
...
impl DepthValidator {
    pub fn push(&self) -> PhpResult<()> {
        Err(ext_php_rs::exception::PhpException::default(
            "Not implemented: push".to_string(),
        ))
    }
...
impl KreuzbergApi {
    ...
    pub fn is_markdown_header(line: String) -> bool {
        kreuzberg::utils::markdown_utils::is_markdown_header(&line)
    }
    ...
    pub fn detect_plain_text_boundaries(text: String) -> Vec<DetectedBoundary> {
        kreuzberg::chunking::boundary_detection::detect_plain_text_boundaries(&text)
            .into_iter()
            .map(Into::into)
            .collect()
    }
    ...
    pub fn classify_chunk(content: String, heading_context: Option<&HeadingContext>) -> String {
        ...
        format!(
            "{:?}",
            kreuzberg::chunking::classify_chunk(&content, heading_context_core.as_ref())
        )
    }
    ...
    pub fn take_or_create_tatr(accel: Option<&AccelerationConfig>) -> Option<String> {
        None
    }

    pub fn return_tatr(model: String) {}

    pub fn take_or_create_slanet(variant: String, accel: Option<&AccelerationConfig>) -> Option<String> {
        None
    }

    pub fn return_slanet(variant: String, model: String) {}

    pub fn take_or_create_table_classifier(accel: Option<&AccelerationConfig>) -> Option<String> {
        None
    }
...
impl From<DetectedBoundary> for kreuzberg::chunking::boundary_detection::DetectedBoundary {
    fn from(val: DetectedBoundary) -> Self {
        Self {
            byte_offset: val.byte_offset as usize,
            is_header: val.is_header,
        }
    }
}
...
impl From<MergedChunk> for kreuzberg::chunking::semantic::merge::MergedChunk {
    fn from(val: MergedChunk) -> Self {
        Self {
            text: val.text,
            byte_start: val.byte_start as usize,
            byte_end: val.byte_end as usize,
